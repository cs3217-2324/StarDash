...
class Player: Entity {
    ...
    init(id: UUID, position: CGPoint, playerSprite: PlayerSprite) {
        self.id = id
    ...
    func setUpAndAdd(to: EntityManager) {
        ...
        let physicsComponent = PhysicsComponent(entityId: self.id, mass: .zero, velocity: .zero, force: .zero, collisionMask: .zero, affectedByGravity: true)
